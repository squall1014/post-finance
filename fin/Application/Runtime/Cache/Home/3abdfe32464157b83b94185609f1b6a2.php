        ...
        <form action="" enctype="multipart/form-data" method="post" class="layui-form" >
         ...
         <table class="layui-table" lay-size="" style="width: 100%">
         	<tr>
         		...
         		<?php if(is_array($title)): $i = 0; $__LIST__ = $title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><th style="text-align:center;"><?php echo ($vo[0]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
         	</tr>
         	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
         		<th style="text-align:center;"><?php echo ($vo["dwname"]); ?></th>
         		<?php if(is_array($titles)): $i = 0; $__LIST__ = $titles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><th style="text-align:center;"><?php echo ($vo[$vos]['sums']); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
