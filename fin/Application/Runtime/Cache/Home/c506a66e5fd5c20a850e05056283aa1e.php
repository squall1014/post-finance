...
<div class="layui-body">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md6">
        <div class="layui-card">
          <div class="layui-card-header">今日已上报</div>
          <div class="layui-card-body">
            <form action="<?php echo U('jrpointperstoday');?>" enctype="multipart/form-data" method="post" class="layui-form">
              <button class="layui-btn">今日上报数量<span class="layui-badge layui-bg-gray"><?php echo ($jsr); ?></span></button>
            </form>
          </div>
        </div>
      </div>
      <div class="layui-col-md6">
        <div class="layui-card">
          <div class="layui-card-header">今日上报被修改</div>
          <div class="layui-card-body">
            <form action="<?php echo U('jrpointperstoday');?>" enctype="multipart/form-data" method="post" class="layui-form">
              <button class="layui-btn">今日上报被修改数量<span class="layui-badge layui-bg-gray"><?php echo ($jsrr); ?></span></button>
            </form>
          </div>
        </div>
      </div>
      <div class="layui-col-md6">
        <div class="layui-card">
          <div class="layui-card-header">昨日已上报</div>
          <div class="layui-card-body">
            <form action="<?php echo U('jrpointpersyesterday');?>" enctype="multipart/form-data" method="post" class="layui-form">
              <button class="layui-btn">昨日上报数量<span class="layui-badge layui-bg-gray"><?php echo ($yjsr); ?></span></button>
            </form>
          </div>
        </div>
      </div>
      <div class="layui-col-md6">
        <div class="layui-card">
          <div class="layui-card-header">昨日上报被修改</div>
          <div class="layui-card-body">
            <form action="<?php echo U('jrpointpersyesterday');?>" enctype="multipart/form-data" method="post" class="layui-form">
              <button class="layui-btn">昨日上报被修改数量<span class="layui-badge layui-bg-gray"><?php echo ($yjsrr); ?></span></button>
            </form>
          </div>
        </div>
      </div>
  ...
  <div style="padding: 20px; background-color: #F2F2F2; width: 60%;">
    ...
    <table class="layui-table" style="width: 100%">
      ...
      <?php if(is_array($jpsrr)): $i = 0; $__LIST__ = $jpsrr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td><?php echo ($vo["pm"]); ?></td>
          <td><?php echo ($vo["dwname"]); ?></td>
          <td><?php echo ($vo["persname"]); ?></td>
