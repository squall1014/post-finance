    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
        ...
        <form action="" enctype="multipart/form-data" method="post" class="layui-form" >
         ...
         <table class="layui-table" lay-size="" >
         	...
         	<tr>
         		<td>网点</td>
         		<?php if(is_array($datefwss)): $i = 0; $__LIST__ = $datefwss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vodate): $mod = ($i % 2 );++$i;?><th><?php echo ($vodate); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
         	</tr>
         	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
         		<td><?php echo ($vo["dwname"]); ?></td>
         		<?php if(is_array($datefwss)): $i = 0; $__LIST__ = $datefwss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vodate): $mod = ($i % 2 );++$i;?><th style="text-align:center;"><?php echo ($vo[$vodate]['sh']); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
