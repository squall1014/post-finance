       ...
       <tr>
       	...
       	<th>片区</th>
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><a href="/rafin/index.php/Home/Index/persjgh/jgh/<?php echo ($vo["dwnameid"]); ?>"><?php echo ($vo["dwname"]); ?></a></td>
				<td><a href="/rafin/index.php/Home/Index/persjgh/jgh/<?php echo ($vo["dwnameid"]); ?>"><?php echo ($vo["count"]); ?></a></td>
				<td><?php if(is_array($vo["wdfzr"])): $i = 0; $__LIST__ = $vo["wdfzr"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo6): $mod = ($i % 2 );++$i;?><a href="/rafin/index.php/Home/Index/persmodify/id/<?php echo ($vo6["id"]); ?>"><?php echo ($vo6["persname"]); ?></a>(<?php echo ($vo6["gongzhong"]); ?>)|<?php endforeach; endif; else: echo "" ;endif; ?></td>
				<td><?php if(is_array($vo["zhgy"])): $i = 0; $__LIST__ = $vo["zhgy"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo5): $mod = ($i % 2 );++$i;?><a href="/rafin/index.php/Home/Index/persmodify/id/<?php echo ($vo5["id"]); ?>"><?php echo ($vo5["persname"]); ?></a>(<?php echo ($vo5['gongzhong']); ?>)|<?php endforeach; endif; else: echo "" ;endif; ?></td>
				<td><?php if(is_array($vo["lcjl"])): $i = 0; $__LIST__ = $vo["lcjl"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo4): $mod = ($i % 2 );++$i;?><a href="/rafin/index.php/Home/Index/persmodify/id/<?php echo ($vo4["id"]); ?>"><?php echo ($vo4["persname"]); ?></a>(<?php echo ($vo4['gongzhong']); ?>)|<?php endforeach; endif; else: echo "" ;endif; ?></td>
				<td><?php if(is_array($vo["ptgy"])): $i = 0; $__LIST__ = $vo["ptgy"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;?><a href="/rafin/index.php/Home/Index/persmodify/id/<?php echo ($vo3["id"]); ?>"><?php echo ($vo3["persname"]); ?></a>(<?php echo ($vo3['gongzhong']); ?>)|<?php endforeach; endif; else: echo "" ;endif; ?></td>
				<td><?php if(is_array($vo["dtjl"])): $i = 0; $__LIST__ = $vo["dtjl"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><a href="/rafin/index.php/Home/Index/persmodify/id/<?php echo ($vo2["id"]); ?>"><?php echo ($vo2["persname"]); ?></a>(<?php echo ($vo2['gongzhong']); ?>)|<?php endforeach; endif; else: echo "" ;endif; ?></td>
