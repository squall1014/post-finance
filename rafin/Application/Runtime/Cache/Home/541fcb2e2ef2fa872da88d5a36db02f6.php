    ...
    <div class="layui-card-body">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["gonghao"]); ?></td>
								<td><?php echo ($vo["zhiwu"]); ?></td>
								<td><?php echo ($vo["gongzhong"]); ?></td>
								<td onclick="pm('<?php echo ($vo["gonghao"]); ?>')"><a href="#"><font color="#ff0000">积分查询</font></a></td>
...
<script>
	function pm(value){
		layer.open({
		    ...
		    ,content: '/rafin/index.php/Home/Index/persjghmodify/gonghao/' + value
		    ,btn: ['全部关闭'] //只是为了演示
