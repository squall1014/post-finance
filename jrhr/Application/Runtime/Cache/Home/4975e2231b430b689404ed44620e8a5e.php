        ...
        <form action="" enctype="multipart/form-data" method="post" class="layui-form" >
         <table class="layui-table" lay-size="" style="width: 100%">
         	...
         	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<th style="text-align:center;"><?php echo ($vo["carsfz"]); ?></th>
				<th style="text-align:center;"><?php echo ($vo["referee"]); ?></th>
				<th style="text-align:center;"><?php echo ($vo["date"]); ?></th>
         		<th style="text-align:center;"><?php if($vo["stats"] == 1): ?><font color="#ff0000"><?php echo ($vo["status"]); ?></font><?php else: echo ($vo["status"]); endif; ?></th>
				<th style="text-align:center;"><a href="/jrhr/index.php/Home/Admin/etccustrefereemodify/etcrefereeid/<?php echo ($vo["etcrefereeid"]); ?>">修改</a></th>
