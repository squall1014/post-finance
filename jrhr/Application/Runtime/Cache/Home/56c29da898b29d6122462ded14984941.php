...
<h1><div style="padding: 15px;">余杭区金融积分考核系统</div></h1>
    <br />
        ...
        <form action="<?php echo U('jrpointupshsuc');?>" enctype="multipart/form-data" method="post" class="layui-form" >
         <table class="layui-table" lay-size="" style="width: 60%">
         	<input type="hidden" name="date" value="<?php echo ($data[0]['date']); ?>">
         	<input type="hidden" name="jgh" value="<?php echo ($data[0]['jgh']); ?>"
         	<tr>
         		<th style="text-align:center;"><input class="all" type="checkbox" id="all" onclick="ckb()"></th>
         	...
         	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
         		<th style="text-align:center;"><input type="checkbox" name="gonghao[]" value="<?php echo ($vo["gonghao"]); ?>"></th>
         		
         		<th style="text-align:center;"><?php echo ($vo["dwname"]); ?></th>
         		<th style="text-align:center;"><?php echo ($vo["zhiwu"]); ?></th>
         		<th style="text-align:center;"><a href="/jrhr/index.php/Home/Admin/jrperspointup/gonghao/<?php echo ($vo["gonghao"]); ?>/date/<?php echo ($vo["date"]); ?>"><font color="#CC0000"><?php echo ($vo["persname"]); ?></font></th>
         		<td style="text-align:center;"><?php echo ($vo["sums"]); ?></td>
         	</tr><?php endforeach; endif; else: echo "" ;endif; ?>
         </table>
         <br />
         <div class="layui-form-item" style="margin-left:300px;">
           <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo">批量审核</button>
