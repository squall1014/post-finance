...
<h1><div style="padding: 15px;">余杭区金融积分考核系统</div></h1>
    <br />
    	...
    	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
			  <legend>ETC客户车辆解约</legend>
			</fieldset>
    	<form class="layui-form layui-form-pane" action="<?php echo U('etccustdeletes');?>" method="post">
    		
    		<div class="layui-form-item" style="margin-left:50px;">
			    <div class="layui-inline">
			      <label class="layui-form-label">车辆查询</label>
			      <div class="layui-input-block">
					<input type="text" name="carcard" list="carcards" id="carcard" autocomplete="off" class="layui-input">
					<datalist id="carcards">
						<?php if(is_array($carcard)): $i = 0; $__LIST__ = $carcard;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["carcard"]); ?>"><?php echo ($vo["carcard"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</datalist>
			      </div>
			    </div>
    		</div>
