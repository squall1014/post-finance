  ...
  <div class="layui-body">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
        ...
        <form action="" enctype="multipart/form-data" method="post" class="layui-form" >
         <table class="layui-table" lay-size="" style="width: 90%">
         	<tr>
         	...
         	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
         		...
         		<th style="text-align:center;"><a href="/jrhr/index.php/Home/Index/jrpointdwdatefwpersinfos/gonghao/<?php echo ($vo["gonghao"]); ?>/date/<?php echo ($vo["date"]); ?>"><font color="#CC0000"><?php echo ($vo["persname"]); ?></font></a></th>
