        ...
        <form action="" enctype="multipart/form-data" method="post" class="layui-form" >
         <table class="layui-table" lay-size="" style="width: 100%">
         	<tr>
         		...
         		<?php if(is_array($javirr)): $i = 0; $__LIST__ = $javirr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><th style="text-align:center;"><?php echo ($vo["item"]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
         		<th style="text-align:center;">定期预测净增</th>
         		<th style="text-align:center;">到期转存率</th>
         		<th style="text-align:center;">他行策反率</th>
         	</tr>
         	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
         		<th style="text-align:center;"><?php echo ($vo["dwname"]); ?></th>
         		<?php if(is_array($javirr)): $i = 0; $__LIST__ = $javirr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><th style="text-align:center;"><?php echo ($vo[$vos['activeitemid']]['point']); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
         		<th style="text-align:center;"><?php echo ($vo[$vo['dwname']]['dqyz']); ?></th>
         		<th style="text-align:center;"><?php echo ($vo[$vo['dwname']]['dqzc']); ?></th>
         		<th style="text-align:center;"><?php echo ($vo[$vo['dwname']]['thcf']); ?></th>
