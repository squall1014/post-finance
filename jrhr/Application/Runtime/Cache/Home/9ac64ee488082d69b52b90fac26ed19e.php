...
<h1><div style="padding: 15px;">余杭区金融积分考核系统</div></h1>
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		...
		<form action="<?php echo U('tfcustoperatemodifys');?>" enctype="multipart/form-data" method="post" class="layui-form">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">金额去向</label>
				<div class="layui-input-inline">
					<select name="itemid">
						<option value="">请选择金额去向</option>
						<?php if(is_array($jdirr)): $i = 0; $__LIST__ = $jdirr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["itemid"]); ?>"><?php echo ($vo["item"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			</div>
			<br />
