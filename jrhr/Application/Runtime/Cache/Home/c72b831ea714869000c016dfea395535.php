    ...
    <br />
        ...
        <table class="layui-table" lay-size="">
         	...
         	<tr>
         	 ...
         	 <td>
         	 	<input type="text" name="sfz" id="sfz" onblur="sfzs()" required lay-verify="identity" placeholder="请输入客户身份证" autocomplete="off" class="layui-input">
         	 </td>
         	 ...
         	 <th>意向产品</th>
         	 <td>
         	 	<select name="product" lay-search>
         	 		<option value=""></option>
