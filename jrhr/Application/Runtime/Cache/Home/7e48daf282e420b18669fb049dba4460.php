  ...
  <div class="layui-body">
    ...
    <h1><div style="padding: 15px;">余杭区金融积分考核系统</div></h1>
    	...
    	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
			  <legend>三、五年存单查询</legend>
			</fieldset>
    	<form class="layui-form layui-form-pane" action="<?php echo U('tfcustoperates');?>" method="post">
    		
    		<div class="layui-form-item" style="margin-left:50px;">
			    <div class="layui-inline">
			      <label class="layui-form-label">存单号</label>
			      <div class="layui-input-block">
			        <input type="text" name="saveid" autocomplete="off" class="layui-input">
			      </div>
			    </div>
    		</div>
    		<br />
