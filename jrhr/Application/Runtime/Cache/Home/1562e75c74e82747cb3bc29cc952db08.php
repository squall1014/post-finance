...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <hr class="layui-bg-red">
        <form action="<?php echo U('jraccountinfocleans');?>" enctype="multipart/form-data" method="post" >
    ...
    <hr class="layui-bg-red">
        <form action="<?php echo U('jrclientassetsoldcleans');?>" enctype="multipart/form-data" method="post" >
    ...
    <hr class="layui-bg-red">
        <form action="<?php echo U('jrclientassetscleans');?>" enctype="multipart/form-data" method="post" >
