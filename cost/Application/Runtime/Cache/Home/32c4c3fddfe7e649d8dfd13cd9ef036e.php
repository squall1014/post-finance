    ...
    <div class="layui-card" style="width: 75%;">
        	<div class="layui-card-header">
        		...
        		<form class="layui-form layui-form-pane" >
    				...
    				<label class="layui-form-label"><?php echo ($data[0]['warehousedwname']); ?></label>
    			</form>
        	</div>
    			<br  />
					<br  />
    			...
    			<form class="layui-form" action="">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["warehousedwname"]); ?></td>
								...
								<td>
							      <a href="/cost/index.php/Home/Index/warehousemodifys/warehouseid/<?php echo ($vo["warehouseid"]); ?>">修改</a>
								</td>
