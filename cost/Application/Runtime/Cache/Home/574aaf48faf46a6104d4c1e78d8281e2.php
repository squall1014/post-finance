...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <br />
    <form class="layui-form" action="<?php echo U('applyproductzeromodifysuc');?>" name="formibs" method="post" style="width: 100%;">
    <table class="layui-table" style="text-align: center; width: 60%;">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<input type="hidden" name="applyzeroid[]" value="<?php echo ($vo["applyzeroid"]); ?>">
								...
								<td><input type="text" name="quantity[]" value="<?php echo ($vo["quantity"]); ?>" id="a<?php echo ($vo["productid"]); ?>" onblur="c<?php echo ($vo["productid"]); ?>()" lay-verify="" placeholder="请输入实际入库数量" autocomplete="off" class="layui-input"></td>
							</tr>
