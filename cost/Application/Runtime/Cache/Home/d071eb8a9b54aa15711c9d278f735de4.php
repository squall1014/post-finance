...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <br />
    <form class="layui-form" name="formib" method="post" style="width: 100%;">
    			<table class="layui-table" style="text-align: center; width: 95%;">
					    ...
					    <tr>
							...
							<?php if(is_array($cazrr)): $i = 0; $__LIST__ = $cazrr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
