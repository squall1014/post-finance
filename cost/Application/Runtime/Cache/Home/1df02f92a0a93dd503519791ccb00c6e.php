        ...
        <hr class="layui-bg-red">
		    ...
		    <div class="layui-inline">
		  	...
		  	<div class="layui-inline">
		  		...
		  		<datalist id="cardid">
         	 		<?php if(is_array($ccir)): $i = 0; $__LIST__ = $ccir;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["card"]); ?>"><?php echo ($vo["card"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
         	 	</datalist>
		  		</form>
		  	</div>
		  		搜索日期：
		  		...
		  		<button class="layui-btn" data-type="reload">搜索</button>
					...
					<script type="text/html" id="toolbarDemo">
					  <div class="layui-btn-container">
					    <button class="layui-btn layui-btn-sm" lay-event="getCheckstatus">挂失申请</button>
					    <!--<button class="layui-btn layui-btn-sm" lay-event="getCheckstats">发卡</button>-->
					  </div>
					</script>
...
<script>
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'client', title:'客户', width:120, sort: true}
      ,{field:'sfz', title:'身份证', width:200, sort: true}
	      ...
	      case 'getCheckstatus':
	        ...
	        if(data.data.length > 1){
		        	...
		        	layer.open({
				        ...
				        ,content: 'pointcardlossdata.html?cardid='+datas+'&cardinid='+datass+'&cardoutid='+dataout
//				        ,btn: ['全部关闭'] //只是为了演示
