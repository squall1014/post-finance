...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		<legend>库存产品费用报表</legend>
	</fieldset>
	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		<legend>报表日期：<?php echo ($date); ?> -- <?php echo ($dates); ?></legend>
	</fieldset>
	<br />
	<div class="layui-card-body">
    <form class="layui-form" action="selectss" method="get"  style="width: 100%;">
						<table class="layui-table" style="text-align: center; width: 90%;">
					      <!--<colgroup>
					       <col width="10%">
					       <col width="10%">
					       <col width="7%">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["vatcost"]); ?></td>
								<td><?php echo ($vo["cost"]); ?></td>
								<td><?php echo ($vo["vatcostck"]); ?></td>
								<td><?php echo ($vo["costck"]); ?></td>
								<td><?php echo ($vo["vatcostrk"]); ?></td>
								<td><?php echo ($vo["costrk"]); ?></td>
								<td><?php echo ($vo["vatcostend"]); ?></td>
								<td><?php echo ($vo["costend"]); ?></td>
