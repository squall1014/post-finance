		      ...
		      <form class="layui-form">
		  		...
		  		<button class="layui-btn" data-type="reload">搜索</button>
					...
					<script type="text/html" id="barDemo">
					  <a class="layui-btn layui-btn-xs" lay-event="edit">申请维护</a>
...
<script>
  ...
  table.render({
    elem: '#test'
    ,url:'<?php echo U("equipmentups");?>'
    ,toolbar: '#toolbarDemo'
    ,title: '用户数据表'
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field:'equipment_subid', title:'ID', width:80, fixed: 'left', unresize: true, sort: true}
	        ...
	        // ,value: data.sumkcquantity
				...
				$.ajax({
					...
					data:{
						...
						reason: value,
						device_subid: data.device_subid,
					},
