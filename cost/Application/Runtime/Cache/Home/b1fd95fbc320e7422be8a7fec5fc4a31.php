  ...
  <div class="layui-body">
    ...
    <div class="layui-card" style="width: 100%;">
        	<div class="layui-card-header">
        		<font size="4">产品申请确认明细查询（透视表）</font>
    			</div>
        <div class="layui-card-body">
        	<div id="myprint" style="overflow-x: auto; overflow-y: auto;">
					    ...
					    <tr>
								<td>网点名称</td>
								<?php if(is_array($productname)): $i = 0; $__LIST__ = $productname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><?php echo ($vo["productname"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
							</tr>
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td><?php echo ($vo["applydwname"]); ?></td>
								<?php if(is_array($productname)): $i = 0; $__LIST__ = $productname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><td><?php echo ($vo[$vos['productid']]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
			          ...
			          <div class="layui-input-block">
			           <button class="layui-btn" id="prt" lay-submit lay-filter="formDemo">打印</button>
			          </div>
			        </div>
			        <script type="text/javascript">
			        	var pt = document.getElementById("prt");
			        	pt.onclick = function printpage(myprint){
