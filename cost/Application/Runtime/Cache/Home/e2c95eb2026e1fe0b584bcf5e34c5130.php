    ...
    <table class="layui-table" style="text-align: center; width: 80%;">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><a href="/cost/index.php/Home/Index/applyproductmodifys/applyid/<?php echo ($vo["applyid"]); ?>">修改</a> | <a href="/cost/index.php/Home/Index/applyproductdel/applyid/<?php echo ($vo["applyid"]); ?>"><font color="#CC0000">废弃</font></a></td>
							</tr>
