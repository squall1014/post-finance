    ...
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <?php if($user["username"] == jrywb or $user["username"] == scyxb): if($user["jrywbqx"] == 1): ?><dd><a href="/cost/index.php/Home/Index/jrywbqxsuc">0库存申请开放</a></dd>
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    		...
    		<table class="layui-table" style="text-align: center; width: 95%;">
					    ...
					    <tr>
							...
							<?php if(is_array($czrr)): $i = 0; $__LIST__ = $czrr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<!--<td><input type="checkbox" name="id[]" value="<?php echo ($vo["pianquname"]); ?>" lay-skin="primary"></td>-->
								<td><?php echo ($vo["zeroid"]); ?></td>
								<td><?php echo ($vo["date"]); ?></td>
								<td><?php echo ($vo["dateo"]); ?></td>
								<td>
									<?php if($vo["stats"] == 1): ?><font color="#CC0000">完成</font>
									<?php else: ?>
										待完成<?php endif; ?>
								</td>
								<td><a href="/cost/index.php/Home/Index/jrywbqxsearchs/date/<?php echo ($vo["date"]); ?>/dateo/<?php echo ($vo["dateo"]); ?>"><font color="#CC0000">查询</font></a></td>
