				...
				<datalist id="productid">
		  		...
		  		<button class="layui-btn" data-type="reload">搜索</button>
					...
					<script type="text/html" id="barDemo">
					  ...
					  <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="cancel">作废</a>
...
<script>
  ...
  table.render({
    elem: '#test'
    ,url:'<?php echo U("applyproductsh_ups");?>'
    ,toolbar: '#toolbarDemo'
    ,title: '用户数据表'
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field:'applyid', title:'ID', width:80, fixed: 'left', unresize: true, sort: true}
      ,{field:'applydwnames', title:'网点机构号', width:150, unresize: true, sort: true}
      ,{field:'applydwname', title:'网点名称', width:200,sort: true}
	  //金融网点、营业网点、寄递、机关
      ,{field:'warehouse', title:'产品仓库', width:120,sort: true}
      ,{field:'productname', title:'产品名称', width:200,sort: true}
      ,{field:'applyquantity', title:'申请数量', width:120,sort: true}
      ,{field:'sumkc', title:'网点实际库存', width:130,sort: true}
      ,{field:'date', title:'申请日期', width:120,sort: true}
	    ...
	    if(obj.event === 'cancel'){
	      layer.confirm('真的要废弃么', function(index){
			$.ajax({
				...
				url:'<?php echo U("applyproductsherr_up");?>',
	        ...
	        // ,value: data.sumkcquantity
			  ...
			  if(parseInt(value) <= 0){
				...
				$.ajax({
					...
					url:'<?php echo U("applyproductshsuc_up");?>',
