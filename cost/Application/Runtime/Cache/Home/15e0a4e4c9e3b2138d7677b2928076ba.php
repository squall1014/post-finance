    		...
    		<table class="layui-table" style="text-align: center; width: 100%;">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["applytodwname"]); ?></td>
								<td><?php echo ($vo["productdwname"]); ?></td>
								<td><?php echo ($vo["productname"]); ?></td>
								<td><?php echo ($vo["unit"]); ?></td>
								<td><?php echo ($vo["warehouse"]); ?></td>
								<td><?php echo ($vo["sjapplyquantity"]); ?></td>
								<td><?php echo ($vo["shenhe"]); ?></td>
								<td><?php echo ($vo["date"]); ?></td>
								<td>
									<?php if($vo["shenhe"] == '待调拨'): ?><a href="/cost/index.php/Home/Index/dwinalloterr/outallotid/<?php echo ($vo["outallotid"]); ?>"><font color="#CC0000">取消</font></a>
									<?php else: ?>
										已确认<?php endif; ?>
								</td>
