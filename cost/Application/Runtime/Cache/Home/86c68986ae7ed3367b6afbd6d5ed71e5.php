...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a href="/cost/index.php/Home/Index/dwcostreport">按日期出库查询</a></dd>
  ...
  <div class="layui-body">
    ...
    <br />
        <form action="<?php echo U('dwallotsearchs');?>" enctype="multipart/form-data" method="post" class="layui-form layui-form-pane" >
        <div class="layui-card" style="width: 60%;">
        	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
					  <legend>产品调拨出入库查询</legend>
					</fieldset>
        <div class="layui-card-body">
        <div class="layui-form-item" style="margin-left:50px;">
        	<label class="layui-form-label">调拨方式</label>
        	<div class="layui-inline">
        	<select name="allot" lay-verify="required" lay-search>
         	 		<option value=""></option>
        ...
        <div class="layui-form-item" style="margin-left:50px;">
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-block">
			        <input type="text" name="date_date" id="test6" lay-verify="required" autocomplete="off" class="layui-input">
			      </div>
			    </div>
    		</div>
         </div>	
