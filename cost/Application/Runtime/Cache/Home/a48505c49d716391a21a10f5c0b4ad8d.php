...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a href="/cost/index.php/Home/Index/applyproductmodify_up">产品请领数量修改</a></dd>
            <dd><a href="/cost/index.php/Home/Index/applyproductsearch">产品请领查询</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
  ...
  <div class="layui-body">
    ...
    <br />
    <form class="layui-form" action="<?php echo U('applyproductmodifysuc');?>" name="formibs" method="post" style="width: 100%;">
					    ...
					    <tr>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<input type="hidden" name="sumkcquantity[]" id="b<?php echo ($vo["productid"]); ?>" value="<?php echo ($vo["kcquantity"]); ?>">
								...
								<td><input type="text" name="applyquantity" value="<?php echo ($vo["applyquantity"]); ?>" id="a<?php echo ($vo["productid"]); ?>" onblur="c<?php echo ($vo["productid"]); ?>()" lay-verify="" placeholder="请输入实际入库数量" autocomplete="off" class="layui-input"></td>
								<td><?php echo ($vo["kcquantity"]); ?></td>
								<td><input class="layui-input" type="text" id="d<?php echo ($vo["productid"]); ?>" readonly="true"></td>
							</tr>
...
<script type="text/javascript">
      function c<?php echo ($vo["productid"]); ?>(){
      	...
      	if(apply <= sum){
      		...
      		document.getElementById("a<?php echo ($vo["productid"]); ?>").value = <?php echo ($vo["applyquantity"]); ?>;
      	}
