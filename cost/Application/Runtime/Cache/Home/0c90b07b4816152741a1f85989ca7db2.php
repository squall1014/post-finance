...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		<legend>合计收款：<?php echo ($cost); ?>元</legend>
	</fieldset>
	<br />
    ...
    <form class="layui-form" action="selectss" method="get"  style="width: 100%;">
					    ...
					    <tr>
							...
							<?php if(is_array($cdor)): $i = 0; $__LIST__ = $cdor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["sumoutquantity"]); ?></td>
