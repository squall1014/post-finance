  ...
  <div class="layui-body">
    ...
    <h1><div style="padding: 15px;">余杭区邮政费用分摊系统</div></h1>
    	...
    	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
			  <legend>网点积分卡入库</legend>
			</fieldset>
    	<form class="layui-form layui-form-pane" action="<?php echo U('pointcardwds');?>" method="post">
           ...
           <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo">立即选择</button>
           </div>
         </div>
      </form>
  </div>
