...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <br />
    	...
    	<form class="layui-form" action="<?php echo U('applyproducts');?>" method="post"  style="width: 80%;">
    		<?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
				  <legend><?php echo ($vo[0][warehouse]); ?></legend>
				  <!--<input type="hidden" name="warehouseid[]" value="<?php echo ($vo[0]['warehouseid']); ?>"  />-->
				</fieldset>
    		<table class="layui-table">
    			<div class="layui-input-inline">
    			<?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><div class="layui-input-inline" style="margin: 5px;">
    				<input type="checkbox" name="<?php echo ($vos["warehouseid"]); ?>[]" value="<?php echo ($vos["productid"]); ?>" title="<?php echo ($vos["productname"]); ?>">
