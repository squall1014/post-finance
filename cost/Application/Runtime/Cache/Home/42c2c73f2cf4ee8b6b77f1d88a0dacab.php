...
<script>
  ...
  table.render({
    elem: '#test'
    ,url:'<?php echo U("outbounddwname_ups");?>'
    ,toolbar: '#toolbarDemo'
    ,title: '用户数据表'
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field:'dwnameid', title:'ID', width:80, fixed: 'left', unresize: true, sort: true}
      ,{field:'dwnames', title:'网点机构号', width:180, unresize: true, sort: true}
      ,{field:'dwname', title:'网点名称', width:200,sort: true}
	  //金融网点、营业网点、寄递、机关
      ,{field:'warehouse', title:'所属机构', width:120,sort: true}
    ...
    $('.demoTable .layui-btn').on('click', function(){    
	  ...
	  table.on('tool(test)', function(obj){
	    ...
	    if(obj.event === 'del'){
		  ...
		  console.log(data);
	      window.location.href = "/cost/index.php/Home/Index/outbounddwname_upout?jgh=" + data.jgh;
