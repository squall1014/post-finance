		...
		<div class="layui-card-body">
			...
			<table class="layui-table" style="text-align: center; width: 100%;">
				...
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($vo["product_one"]); ?></td>
						<td><?php echo ($vo["money_one"]); ?></td>
						<td><?php echo ($vo["product_two"]); ?></td>
						<td><?php echo ($vo["money_two"]); ?></td>

						<td><?php echo ($vo["capitals"]); ?></td>
						<td><?php echo ($vo["facilitates"]); ?></td>
						<td><?php echo ($vo["insdates"]); ?></td>

						<td><?php echo ($vo["phonebank"]); ?></td>
						<td><?php echo ($vo["expdate"]); ?></td>
